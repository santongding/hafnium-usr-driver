...
extern spinlock_t hf_send_lock;
extern struct page *hf_send_page;
extern struct page *hf_recv_page;
...
static void handle_input(void *input, size_t len)
{
	...
	struct ffa_value ret =
		ffa_msg_send_direct_req(current_vm_id, callee_id, 23, 0, 0, 0, 0);
...
static void share_mem(void)
{
	...
	EXPECT_EQ(ffa_memory_region_init_single_receiver(
			  mb.send, HF_MAILBOX_SIZE, current_vm_id, 2, constituents,
